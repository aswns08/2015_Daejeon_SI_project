			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-sm-9 col-md-10 main">
					...
					<div class="well bs-component">
						...
						<form class="form-horizontal" name="recipeWriteForm" action="recipeWrite.app" method="post">
						...
						<input type="hidden" id="userId" value="${loginUser.id}">
							...
							<div class="form-group">
								...
								<input type="text" id="recipe_title" name="recipe_title" class="form-control" placeholder="제목을 입력하세요">
							</div>

							<div class="form-group">
								<label for="recipe_content">내 용</label>
								<textarea id="recipe_content" name="recipe_content" class="form-control" rows="10" cols="7" placeholder="내용을 입력하세요."></textarea>
							</div>
							<br>

							<div class="form-group">
								<input type="button" class="btn btn-default col-sm-1" onclick="recipeWriteCancel()" value="취소">
								<input type="button" class="btn btn-primary col-sm-1" onclick="recipeWrite()" value="등록하기">
							</div>
